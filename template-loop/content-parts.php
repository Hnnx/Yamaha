...
<a href="<?php the_permalink(); ?>" <?php post_class('loop-item single-product card rounded-1 text-reset p-2 d-flex flex-column'); ?>>
	...
	<h4 class="my-3 fw-normal"><?php the_title();?></h4>
