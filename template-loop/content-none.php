...
<section class="no-results not-found">
	<h5>Iskalna poizvedba ni vrnila rezultatov</h5>
	<a href="<?php echo site_url().'/arhiv-novic';?>">Ponastavi rezultate</a>
</section><!-- .no-results -->
...
<section class="no-results not-found">
	...
	<header class="page-header">
		...
		<h1 class="page-title my-0"><?php esc_html_e( 'Nothing Found', 'understrap' ); ?></h1>
